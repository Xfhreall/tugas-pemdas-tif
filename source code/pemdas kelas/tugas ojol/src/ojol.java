 ...
 * @author RisqiFahreal
 * 
 * JIKA INGIN COPY KEDUA CODE. SETELAH DI PASTE,COMMENT LAH SALAH SATU DARI KODE YANG ANDA TIDAK GUNAKAN.
...
public class ojol {
    ...
    public static void main(String[] args) {
        ...
        // =============================KODE 1==========================
        /*
         * CARA PENYELESAIAN 1 (MENGGUNAKAN LOGIKA SEDERHANA DAN SESUAI KELAS PAK BUDI)
         ...
         */
        Scanner input = new Scanner(System.in);
        System.out.println("Silahkan pilih kendaraan anda (huruf kapital sesuaikan dengan opsi):");
